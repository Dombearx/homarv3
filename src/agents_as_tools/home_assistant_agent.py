...
home_assistant_mcp_server = MCPServerSSE(
    os.getenv("HOME_ASSISTANT_MCP_URL", "http://192.168.50.30:8123/mcp_server/sse"),
    headers={"Authorization": f"Bearer {os.getenv('HOME_ASSISTANT_TOKEN')}"},
)

HOME_ASSISTANT_AGENT_PROMPT = """
You are an interface to the Home Assistant API. Execute user commands precisely and always use proveded tools interact with Home Assistant.
"""
...
@home_assistant_agent.instructions
